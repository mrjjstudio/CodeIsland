...
- **支持 12 种 AI 工具** — Claude Code、Codex、Gemini CLI、Cursor、Copilot、Trae/Traecli、Qoder、Factory、CodeBuddy、OpenCode、Kimi Code CLI、Pi
...
| | <img src="Sources/CodeIsland/Resources/cli-icons/pi.png" width="16"> [Pi](https://github.com/badlogic/pi-mono) | 6 | 终端 | 完整 |
...
**Pi** 通过 TypeScript 扩展，利用 [pi extension API](https://github.com/badlogic/pi-mono) 将 Agent 生命周期事件（会话、工具调用、Agent 轮次）转发到 socket。
